...
export const projectsData = [
    {
      id: 1,
        ...
        link: 'https://tstradingacademy.com/', // Yahan live link daal dena
        image: crefin,
    },
{
        ...
        link: 'https://brokerpad.in', // Play store link ya website link yahan daal sakte ho
        image: crefin, // Upar 'import brokerPad from ...' lagana mat bhoolna
    },
    {
    id: 3,
    name: 'The Philly Food Fanatic (SEO Blog Platform)',
    description: "Developed and optimized a high-performance blog website using Next.js with a strong focus on SEO. Implemented server-side rendering (SSR), dynamic routing, and structured metadata to improve search engine visibility. Worked on performance optimization, content structuring, and responsive UI to enhance user engagement. Collaborated on content strategy and ensured fast load times and accessibility best practices.",
    tools: ['Next.js', 'ReactJS', 'SEO', 'SSR', 'Tailwind CSS', 'JavaScript', 'Vercel'],
    code: '',
    link: 'https://www.thephillyfoodfanatic.com/',
    image: "phillyfoodfanatic",
    role: 'Full Stack Developer',
},
    {
        id: 4,
        ...
        role: 'Full Stack Developer',
        code: '',
        link: 'https://marketplace.microsoft.com/en-us/product/WA200008025',
        image: travel,
    },
    {
        id: 5,
        ...
        code: '',
        role: 'Full Stack Developer',
        link: 'https://marketplace.microsoft.com/en-us/product/WA200005552',
        image: realEstate,
    },
    {
        id: 6,
        ...
        code: '',
        link: 'https://marketplace.microsoft.com/en-us/product/WA200004982',
        image: "ayla",
        role: 'Full Stack Developer',
    },
